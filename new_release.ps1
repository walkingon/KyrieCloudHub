...
Write-Host "Check progress at: https://github.com/walkingon/KyrieCloudHub/actions" -ForegroundColor Cyan
Write-Host "View releases at: https://github.com/walkingon/KyrieCloudHub/releases" -ForegroundColor Cyan
